...
x.jsxEqual = function (val, expected, msg) {
	var treeEquals = reactElementToJSXString(val) === reactElementToJSXString(expected);
	test(treeEquals, create(val, expected, '===', msg, x.jsxEqual));
};

x.notJsxEqual = function (val, expected, msg) {
	var treeEquals = reactElementToJSXString(val) === reactElementToJSXString(expected);
	test(!treeEquals, create(val, expected, '!==', msg, x.jsxEqual));
};
